      ...
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#0f1117;color:#e8eaf0;border-radius:12px;overflow:hidden;">
        ...
        <div style="padding:28px;">
          ...
          <div style="background:#0d2137;border-radius:12px;padding:16px;margin-bottom:20px;">
            <h3 style="margin:0 0 12px;font-size:14px;color:#4db3ff;">📋 What happens next?</h3>
          ...
          <div style="background:#0d2137;border-radius:12px;padding:16px;margin-bottom:20px;">
            <h3 style="margin:0 0 12px;font-size:14px;color:#4db3ff;">📞 Need help?</h3>
            <div style="font-size:13px;color:#9ca8b8;line-height:1.8;">
              📱 Call/WhatsApp: <a href="tel:+919082166108" style="color:#4db3ff;">+91 90821 66108</a><br/>
          ...
          <div style="text-align:center;">
            <a href="https://wa.me/919082166108?text=Hi+I+have+a+query+about+booking+${booking.booking_ref}"
...
function row(label, value) {
  return `<tr>
    <td style="padding:10px;border-bottom:1px solid #1e2535;color:#9ca8b8;font-size:13px;width:40%;">${label}</td>
    <td style="padding:10px;border-bottom:1px solid #1e2535;font-size:13px;">${value}</td>
  </tr>`;
}
...
// ================================================================
async function sendBookingEmail(booking, customerEmail) {
  await Promise.allSettled([
    sendAdminEmail(booking),
    sendCustomerEmail(booking, customerEmail)
  ]);
}
